...
import com.maciej.poreba.backend.authservice.payload.ExternalServiceWithTokenLoginRequest;
import com.maciej.poreba.backend.authservice.payload.JwtAuthenticationResponse;
import com.maciej.poreba.backend.authservice.payload.LoginRequest;
import com.maciej.poreba.backend.authservice.payload.SignUpRequest;
